...
const MainRoot = ({ closeMainRoot }) => {
  ...
  const DeleteFile = () => {
    ...
    axios
      .post(
        url + "api/businesses/" + cookies.get("b-Id") + "/documents/" + file.id,
        {
          _method: "DELETE",
        },
        {
      ...
      .then(function (response) {
        ...
        } else toast.error("عملیات با مشکل مواجه شد. مجددا سعی فرمایید!");
      })
