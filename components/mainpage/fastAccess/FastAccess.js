...
import CardFastaccess from './card/CardFastaccess';

import picMenu1 from '/public/assets/img/banners/menu1.png'
import picMenu2 from '/public/assets/img/banners/menu2.png'
import picMenu3 from '/public/assets/img/banners/menu3.png'
import picMenu4 from '/public/assets/img/banners/menu4.png'
...
const items = [
  ...
  { key: '2', image: pic2.src },
  { key: '3', image: pic3.src },
  { key: '4', image: pic4.src },
  { key: '5', image: pic5.src },
  { key: '6', image: pic6.src },
  ];
...
const FastAccess = () => {
  ...
  return (
    <div className=' bg-[#f3f4f6] w-[90%] py-10 mx-auto mt-[40px] mb-[20px]'>
      <div className='flex justify-start px-[100px] mb-[30px] mt-[40px]'>
          <div>
          ...
          <div className='text-right  mr-3'>
            ...
            <p className='mt-3 text-[14px]'>
              خیلی راحت کالا یا خدماتی که دنبالش هستی رو پیدا کن
            </p>
          </div>
        </div>
      <div className='flex justify-center m-auto px-[100px]'>
        <div className='flex'>
          <div className="custom-swiper-tools d-flex flex-col align-items-center justify-content-between mt-3 px-2">
            <div class="custom-navigation d-flex flex-col relative ps-1">
              <div class="slider-button-prev -rotate-90 mt-0 left-0 relative ">
              ...
              <div class="slider-button-next right-0 mt-2 -rotate-90 relative">
                <svg className="text-[#3B82f6]" width="23" height="16" viewBox="0 0 23 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="swiper-pagination-custom d-flex rotate-90 justify-content-end w-100">
        <svg className="w-[px] bottom-[20px] h-[30px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"/></svg>
        </div>
          </div>
        <div className='flex flex-col justify-center w-fit rounded-xl ml-4 bg-[#ffffff] py-1 px- h-[710px]' >
          <Swiper
      ...
      <div className=''>
        <div>
          <Image className='rounded-xl' src={picMenu1} alt='banner' max-width='500' height='2500'/>
        </div>
        <div className='flex'>
          <div className='ml-3'>
            <Image className='rounded-xl' src={picMenu2} alt='banner' width='210' height='150'/>
          </div>
          <div className='ml-3'>
            <Image className='rounded-xl' src={picMenu3} alt='banner' width='400' height='150'/>
          </div>
          <div>
            <Image className='rounded-xl' src={picMenu4} alt='banner' width='400' height='150'/>
          </div>
        </div>
      </div>
      </div>
