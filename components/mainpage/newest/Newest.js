...
import CardNewest from './card/CardNewest'
        ...
        <div className='flex justify-start'>
          ...
          <div className='text-right  mr-3'>
            ...
            <p className='mt-3 text-[14px]'>
              محصولاتی که به تازگی اضافه شده اند
            </p>
          </div>
        </div>
