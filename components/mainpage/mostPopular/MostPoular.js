...
import CardNewest from '../newest/card/CardNewest'
import CardMostPopular from './card/CardMostPopular'
...
import bannerPopular from '/public/assets/img/banners/menu01-2-01 (2).jpg'
...
const MostPoular = () => {
  return (
    <div>
        ...
        <div className='flex justify-start'>
          ...
          <div className='text-right mr-3'>
            ...
            <p className='mt-2 text-[12px]'>
              پرطرفدارترین کالاها در دسترس شماست
            </p>
          </div>
        </div>
      ...
      <div className='mx-auto' style={{display: 'flex', justifyContent:'start', alignItems:'start'}}>
        <div className=' rounded-md'>
          <Image className='rounded-tr-[20px] rounded-br-[20px]' src={bannerPopular} alt='banner' width='300' height='600' />
        </div>
        <div className=''>
          <div className='flex justify-center items-center max-h-[600px] max-w-[950px]  px-2  py-2 bg-[#075985] rounded-tl-xl rounded-bl-xl'>
            <Swiper 
          ...
          <div className="custom-swiper-tools mt-3">
            <div className='flex justify-between'>
              <div class="custom-navigation ps-1">
              <div className='flex'>
                <div class="slider-button-prev relative ">
                  <svg className='text-[#075985]' width="23" height="16" viewBox="0 0 23 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* <div className='bg-[#075985] p-2'>
          <div className='flex justify-between flex-wrap bg-[#ffffff] max-w-[850px] rounded-tl-xl rounded-bl-xl'>
            <CardMostPopular/>
            <CardMostPopular/>
            <CardMostPopular/>
            <CardMostPopular/>
