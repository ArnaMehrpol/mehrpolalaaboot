        ...
        <div>
          <table className="table table-bordered table-responsive">
            ...
            <tr>
              ...
              <td className="text-center pt-4 text-primary">پرداخت موفق</td>
            </tr>
          </table>
        </div>
      </div>
      <div className="d-flex justify-content-end mt-5">
        <Link href={"#"}>
          <a className="btn btn-primary">
            پیگیری سفارش <i className="bi bi-arrow-left me-1"></i>
          </a>
        </Link>
      </div>
    </>
...
export default Successinfotable;
