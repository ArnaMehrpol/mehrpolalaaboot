      ...
      <div className="business-panel-container">
        <div className="business-panel-cols grid grid-cols-12 bg-slate-100 ">
          <div className="business-panel-sidbar lg:col-span-2 col-span-12 my-8">
            <nav className="navbar navbar-business navbar-business-expand-lg navbar-expand-lg">
              <div class="navbar-business-container container-fluid mx-4">
                <div className="top-nav w-100 d-flex">
          ...
          <div className="business-panel-mainbar lg:col-span-10 col-span-12 shadow-lg shadow-slate-100 relative overflow-hidden">
            <header className="header-container max-w-screen-xl px-12 mx-auto bg-white lg:h-[60px] relative z-[99999999]">
            ...
            <section className="slides-container max-w-screen-lg mx-auto flex justify-center items-center relative z-[9999] mt-[85px]">
                ...
                <div className="btn-add inline-flex">
                  ...
                  <div className="slides-cols grid grid-cols-12 gap-3 mt-4">
                    <div className="slide-col lg:col-span-3 col-span-12">
                      <div className="slide-col-image bg-slate-50 w-full h-32 rounded-md relative">
                        <div className="slide-col-bg bg-white py-[2.92rem] px-1 absolute left-0 opacity-60 z-[999] ">
                          <div className="slide-col-icons w-full h-full flex flex-col items-center justify-center space-y-4 -mt-3">
                            <Link href="/">
                              <a>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="slide-col lg:col-span-3 col-span-12">
                      <div className="slide-col-image bg-slate-50 w-full h-32 rounded-md relative">
                        <div className="slide-col-bg bg-white py-[2.51rem] px-1 absolute left-0 opacity-60 z-[999] rounded-md rounded-r-none">
                          <div className="slide-col-icons w-full h-full flex flex-col items-center justify-center space-y-4 -mt-3">
                            <Link href="/">
                              <a>
                                <svg
