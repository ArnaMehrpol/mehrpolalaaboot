      ...
      <div className="business-panel-container">
        <div className="business-panel-cols grid grid-cols-12 bg-slate-100 ">
          ...
          <div className="business-panel-mainbar lg:col-span-9 col-span-12 shadow-lg shadow-slate-100 relative overflow-hidden">
            ...
            <section className="slides-container max-w-screen-lg mx-auto flex justify-center items-center relative z-[9999] lg:mt-[85px] mt-[42px]">
              <div className=" bg-white overflow-hidden rounded-lg shadow-md px-5">
                <div className="slides-title flex flex-col my-4">
                  <h5 className="text-base font-semibold">چارت سازمانی</h5>
                  <small className="text-slate-600 text-xs mt-0.5">
                    چارت سازمانی خود را در این قسمت وارد کنید
                  </small>
                </div>
                <div className="slides-flex flex flex-col">
                  ...
                  <div className="slides-cols grid grid-cols-12 gap-3 mt-4">
                    <div className="slide-col lg:col-span-5 col-span-12">
                      <div className="slide-col-chart bg-white w-full h-full rounded-md relative">
                        <div className="slide-col-bg bg-white py-[2.90rem] px-1 absolute lg:left-0 left-[137px]  opacity-60 z-[999] ">
                        ...
                        <Image
                          src="/../public/assets/img/pic/chartt.jpg"
                          width="250px"
                          height="130px"
                  ...
                  <div className="slides-text flex items-center">
                    ...
                    <p className="text-slate-600 text-xs my-4">
                      برای نمایش بهتر توصیه می شود چارت در فرمت پی دی اف و با
