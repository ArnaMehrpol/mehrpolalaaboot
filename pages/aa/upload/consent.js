      ...
      <div className="business-panel-container">
        <div className="business-panel-cols grid grid-cols-12 bg-slate-100 ">
              ...
              <div class="navbar-business-container container-fluid mx-4">
                <div className="top-na d-flex">
                  ...
                  <div className="business-name flex flex-col mr-3">
                    ...
                    <small className="text-xs">آرش محمدی
                    </small>
                  </div>
                </div>
                <button
                ...
                >
                  <div class="business-navbar-nav navbar-nav">
                    <div className="business-nav-item-upload-active nav-item bg-blue-500 rounded-md px-4 mb-3">
          ...
          <div className="business-panel-mainbar lg:col-span-9 col-span-12 shadow-lg shadow-slate-100 relative overflow-hidden">
            ...
            <section className="consent-container max-w-screen-lg mx-auto flex justify-center items-center relative z-[9999] mt-[85px]">
              <div className=" bg-white overflow-hidden rounded-lg shadow-md px-5">
                <div className="consent-title flex flex-col my-4">
                  <h5 className="text-base font-semibold">رضایت نامه</h5>
                  <small className="text-slate-600 text-xs mt-0.5">
                    رضایت نامه های مرتبط با کسب و کار را در این قسمت وارد کنید 

                  </small>
                </div>
                <div className="consent-flex flex flex-col">
                <div className="btn-add inline-flex">
                    <Link href="/">
                      <a className="link-add-slide w-40 h-full px-2.5 py-1.5 border border-slate-400 rounded-md flex items-center justify-between">
                  ...
                  <div className="consent-cols grid grid-cols-12 gap-3 mt-4">
                  <div className="image-col lg:col-span-3 md:col-span-4 col-span-12">
                      <div className="image-col-image bg-slate-50 h-44 w-44 rounded-md relative">
                        <div className="image-col-bg bg-slate-200 py-16 px-1 absolute left-0 opacity-60 z-[999] rounded-md rounded-r-none">
                        ...
                        <Image
                          src="/../public/assets/img/pic/consent.jpg"
                          width="250px"
                          height="260px"
                    ...
                    <div className="image-col lg:col-span-3 md:col-span-4 col-span-12">
                      <div className="image-col-image bg-slate-50 h-44 w-44 rounded-md relative">
                        <div className="image-col-bg bg-slate-200 py-16 px-1 absolute left-0 opacity-60 z-[999] rounded-md rounded-r-none">
                          <div className="image-col-icons w-full h-full flex flex-col items-center justify-center space-y-4 -mt-">
                            <Link href="/">
                              <a>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="next-btn w-full h-full border-t-2 border-dotted border-slate-100 flex justify-end items-center my-6">
                    <Link href="/">
