    ...
    <div>
      <div className="business-panel-container">
        <div className="business-panel-cols grid grid-cols-12 bg-slate-100 ">
          <div className="business-panel-sidbar lg:col-span-2 col-span-12 my-8">
            <nav className="navbar navbar-business navbar-business-expand-lg navbar-expand-lg">
              <div class="navbar-business-container container-fluid mx-4">
                <div className="top-na d-flex">
                  <div className="business-logo w-14 h-14 rounded-full bg-white">
                    <Link href="/">
                      <Image
                        src="/../public/assets/img/logos/1.jpg"
                        width="60px"
                        height="60px"
          ...
          <div className="business-panel-mainbar lg:col-span-10 col-span-12 shadow-lg shadow-slate-100 relative overflow-hidden">
            <header className="header-container max-w-screen-xl px-12 mx-auto bg-white nv-[60px] relative z-[99999999] h-[60px]">
            ...
            <section className="images-container max-w-screen-lg mx-auto flex justify-center items-center relative z-[9999] mt-[85px]">
              <div className=" bg-white overflow-hidden rounded-lg shadow-md px-5">
                ...
                <div className="btn-add inline-flex">
                    <Link href="/">
                      <a className="link-add-slide w-36 h-full px-2.5 py-1.5 border border-slate-400 rounded-md flex items-center justify-between">
                  ...
                  <div className="images-cols grid grid-cols-12 gap-3 mt-4">
                    <div className="image-col lg:col-span-3 col-span-12">
                      <div className="image-col-image bg-slate-50 h-44 w-44 rounded-md relative">
                        <div className="image-col-bg bg-white py-[4.5rem] px-1 absolute left-0 opacity-60 z-[999] ">
                          <div className="image-col-icons w-full h-full flex flex-col items-center justify-center space-y-4 -mt-3">
                            <Link href="/">
                              <a>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                        ...
                        <Image
                          src="/../public/assets/img/sliders/1.jpg"
                          width="250px"
                          height="260px"
                    ...
                    <div className="image-col lg:col-span-3 col-span-12">
                      <div className="image-col-image bg-slate-50 h-44 w-44 rounded-md relative">
                        ...
                        <Image
                          src="/../public/assets/img/sliders/2.jpg"
                          width="250px"
                          height="260px"
                          className="overflow-hidden rounded-md"
                        ></Image>
                    ...
                    <div className="image-col lg:col-span-3 col-span-12">
                      <div className="image-col-image bg-slate-50 h-44 w-44 rounded-md relative">
                        <div className="image-col-bg bg-white py-[4.5rem] px-1 absolute left-0 opacity-60 z-[999] rounded-md rounded-r-none">
                          <div className="image-col-icons w-full h-full flex flex-col items-center justify-center space-y-4 -mt-3">
                            <Link href="/">
                              <a>
                                <svg
                        ...
                        <Image
                          src="/../public/assets/img/sliders/3.jpg"
                          width="250px"
                          height="260px"
                          className="overflow-hidden rounded-md"
                        ></Image>
                    ...
                    <div className="image-col lg:col-span-3 col-span-12">
                      <div className="image-col-image bg-slate-50 h-44 w-44 rounded-md relative">
                        ...
                        <Image
                          src="/../public/assets/img/sliders/4.jpg"
                          width="250px"
                          height="260px"
                          className="overflow-hidden rounded-md"
                        ></Image>
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-slate-400 ml-2">
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
</svg>

                 <p className="text-slate-600 text-xs my-4">
                    برای نمایش بهتر تصاویر توصیه می شود سایز تصاویر ۴۸۰ در
                    ۷۰۰ پیکسل و حداکثر حجم ۳۰۰ کیلو بایت باشد.{" "}
                  </p>
                 </div>
                </div>
