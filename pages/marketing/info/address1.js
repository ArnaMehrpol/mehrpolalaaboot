...
const address = () => {
  return (
    <div className='flex max-w-screen-2xl bg-light md:px-12 pt-3 mx-auto'
    dir="rtl">
      <div>
        <MarketingInfoSide/>
      </div>
      <div>      
        <div className="mx-auto business-panel-container w-[1100px] bg-slate-100 p-5">
          <section className="max-w-screen-md mx-auto my-14 relative z-[10] bg-white">
