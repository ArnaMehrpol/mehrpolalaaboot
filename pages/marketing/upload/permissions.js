          ...
          <div className="business-panel-mainbar w-100 lg:col-span-9 col-span-12 shadow-lg shadow-slate-100 relative overflow-hidden">
            ...
            <section className="permissions-container max-w-screen-lg px-3 mx-auto flex justify-center items-center relative z-[] mt-16">
              <div className=" bg-white overflow-hidden rounded-lg shadow-md px-5">
                  ...
                  <div className="permissions-cols grid grid-cols-12 gap-3 mt-4">
                    <div className="image-col lg:col-span-3 md:col-span-4 col-span-12">
                      <div className="h-full w-44 image-col-image bg-slate-50  rounded-md relative">
                        <div className="w-7 h-full image-col-bg bg-black absolute left-0 opacity-50 rounded-md rounded-r-none ">
                ...
                <div className="next-btn w-full h-full border-t-2 border-dotted border-slate-100 flex justify-end items-center py-2">
                  <Link href="/">
